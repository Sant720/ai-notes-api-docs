...
All endpoints and responses are **mocked using Postman**, and the documentation is written in **MDX** with **Nextra** for a clean, developer-friendly browsing experience.
...
| Tool | Purpose |
|------|----------|
| **Nextra (Next.js)** | Static documentation site generator |
| **Postman** | API mock server, collection, and examples |
| **OpenAPI 3.0 (Swagger)** | Machine-readable API schema |
...
- Structured **OpenAPI 3.0** specification (`/openapi.yaml`)
...
1. Clone the repository
   ...
   ```bash
    git clone https://github.com/Sant720/ai-notes-api-docs
   ```
